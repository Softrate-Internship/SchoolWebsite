...
<h1 style="margin-left: 3%;">Make Announcement</h1>
<br>
...
<?php 
    ...
    if(isset($_POST["submit"])){
        ...
        $sql = "INSERT INTO announcements (heading,body,file,date) VALUES('$heading','$body','$fileName','$currentDate');";
        $res=mysqli_query($conn,$sql);
        if($res==1){ ?>
        <script>
        ...
        <?php 
            ...
            <script>
                ...
                window.location.href='announcements.php?name=<?php echo $name;?>';            
            </script>
            <?php
        }
    }
