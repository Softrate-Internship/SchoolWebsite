...
if(isset($_GET["email"])){ 
    ...
    if($res){      
        ...
        if($count==1){
            ...
            ?>
            <script>
                window.location.href='home.php?name=<?php echo $row['name'];?>';            
            </script>
            <?php
            }
            else{ ?>
                ...
                <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="about-us.html#mu-our-teacher">Staffs</a></li>
                            <li><a href="#">Acadamic Results</a></li>
...
<!-- Start input -->
<br>
<h1 style="margin-top: 7%;"></h1>
<div class="input-container" style="background-color:white;border: none">
    <form action="login.php">
        <h1 style="text-align: center;font-size: 120%; color: black">Login</h1>
        <br>
        <input type="email" name="email" placeholder="Email" style="margin-left: 5px;" class="input-field" required>
        <br><br>
        <input type="password" name="password" placeholder="password" style="margin-left: 5px;" class="input-field" required>
        <br><br><br>
