...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $sql = "SELECT file FROM announcements WHERE id=$id";
    $res = $conn->query($sql);
    $row = $res->fetch_assoc();
    $f = $row['file'];
    if($f!=""){
                ...
                <div class="col-md-12">
                    <div class="mu-page-breadcrumb-area">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Important Announcements</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="mu-course-container mu-blog-archive">
                                    <div class="row">
                                        ...
                                        ?>            
                                        <div class="col-md-6 col-sm-6" id="box<?php echo $row['id'];?>">
                                            <article class="mu-blog-single-item">
                                                <figure class="mu-blog-single-img">
                                                    <?php if($row['file']!=""){ ?><a href="#"><img src="uploadedFiles/announcements/<?php echo $row['file']; ?>"></a> <?php } ?>
                                                ...
                                                <div class="mu-blog-description">
                                                    ...
                                                    <a href="editAnnouncements.php?name=<?php echo $name;?>&id=<?php echo $row['id'];?>"><button class="mu-read-more-btn" style="color: black; border-radius: 30px;">Edit</button></a>
...
<script>
    function redirect(){
        closeForm();
        window.location.href="adminAnnouncements.php?name=<?php echo $name;?>&id="+window.v;
    }
